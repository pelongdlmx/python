import json
from flask import Flask, url_for, redirect, session, request, jsonify, make_response
...
def show_users():
    ...
    cols = ["name", "username", "email", "date_added", "admin_user"]
    our_users = Users.query.all()
    result = [{col: getattr(d, col) for col in cols} for d in our_users]
